addLayer("p", {
    ...
    upgrades: {
      ...
      25: {
        ...
        unlocked() { return (hasMilestone('G', 5)) && (hasUpgrade('p', 24)) },
      },
    },
    passiveGeneration(){
